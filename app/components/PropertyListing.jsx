...
const PropertyListing = () => {
  return (
    <div >
      <section className="flex w-[1216px] flex-col justify-between items-center m-auto py-[36px] gap-[var(--6,32px)]">
        <div>
          <div className="text-[var(--primary-7,#449A2B)] font-inter text-[20px] font-semibold leading-[120%]">
          PROPERTIES IN DEMAND
          </div>

          <div className="flex justify-between items-center self-stretch">
            <div>
              <header className="flex flex-col items-start py-[4px] gap-[var(--4,16px)] self-stretch">
                <section className="flex flex-col self-stretch my-auto min-w-[240px] w-[800px] max-md:max-w-full">
                  <h1 className="text-[var(--secondary-6,#314660)] font-inter text-[32px] font-semibold leading-[120%]">
                  ...
                  <p className="mt-4 text-lg leading-7 text-slate-500 max-md:max-w-full">
                    ...
                    locations, competitive prices, and modern amenities. Browse
                    our handpicked selection to find your perfect home or room
                    today.
                  </p>
                </section>
              </header>
