          ...
          <div className="flex flex-col items-center gap-[24px]">
            ...
            <div className="flex flex-col items-center gap-[8px]">
              ...
              <div className="flex items-center gap-[4px]">
                ...
                <p className="text-[#314660] font-inter text-[18px] font-medium leading-normal">5 Star Rated by Tenants</p>
              </div>
            </div>
            {/* reply rating */}
            <div className="flex flex-col items-center gap-[3px]">
              <div className="flex items-center gap-[4px]">
                <p className="text-[#56677D] font-inter text-[18px] font-normal leading-[150%]">Reply Rating:</p>
                <p className="text-[#56677D] font-inter text-[18px] font-semibold leading-normal">98%</p>
              </div>
              <div className="flex items-center gap-[4px]">
                <p className="text-[#56677D] font-inter text-[18px] font-normal leading-[150%]">Reply time:</p>
                <p className="text-[#56677D] font-inter text-[18px] font-semibold leading-normal">2 Days</p>
              </div>
            </div>
          </div>
        </div>
