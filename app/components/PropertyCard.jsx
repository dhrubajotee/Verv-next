...
const PropertyCard = ({ price, location, beds, bathrooms, area, image }) => {
  return (
    <article className="flex flex-col grow shrink self-stretch pb-8 my-auto bg-white rounded-3xl min-w-[240px] shadow-[0px_4px_20px_rgba(0,0,0,0.08)] w-[307px]">
      <img loading="lazy" src={image} alt="Property" className="object-contain w-full rounded-none aspect-[1.78]" />
      <div className="flex relative flex-col mx-6 mt-4 max-md:mx-2.5">
        <div className="flex z-0 flex-col w-full">
          ...
          <div className="flex flex-col mt-4 w-full">
            <h2 className="text-2xl font-semibold leading-tight text-slate-700">
              Palm Harbor
            </h2>
        ...
        <div className="z-0 mt-4 w-full bg-gray-100 border-2 border-gray-100 border-solid h-[1.5px] min-h-[1px]" />
        <div className="flex z-0 gap-9 justify-between items-start mt-4 w-full text-sm text-slate-500">
          <div className="flex gap-2 justify-center items-center">
            ...
            <div className="self-stretch my-auto">{beds} Beds</div>
          </div>
          ...
          <div className="flex gap-2 justify-center items-center">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/1608a42af637ff8c191fdece8dcd4daec3501a8faaaab838f0b307ef8b41890b?placeholderIfAbsent=true&apiKey=0695793bd5f84155941de1175594a2be" alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
            <div className="self-stretch my-auto">{area} m²</div>
          </div>
        </div>
